...
<head>
    ...
    <title>Límite de matrícula alcanzado | UNI</title>
...
<body class="min-h-screen flex items-center justify-center bg-background-light dark:bg-background-dark text-[#0d111b] dark:text-white">
    ...
    <div class="max-w-md w-full bg-white dark:bg-[#1a202c] border border-[#cfd5e7] dark:border-gray-700 rounded-xl shadow-sm p-8 text-center">
        ...
        <h1 class="text-2xl font-bold mb-2">
            Límite de matrícula alcanzado
        </h1>

        <!-- Mensaje -->
        <p class="text-[#4c5f9a] text-sm mb-6">
            Ya te has matriculado en el número máximo permitido de cursos o estás intentando exceder ese límite
            (<strong>2 cursos</strong>) para este período académico.
            Para continuar, deberás retirar uno de los cursos actuales
            o esperar a una habilitación administrativa.
        </p>
